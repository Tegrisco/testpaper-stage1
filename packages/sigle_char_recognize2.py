...
#初始化参数
chi_dict = os.path.join(BASE_DIR, 'oral/dict/chi_dict') #中文字典
eng_dict = os.path.join(BASE_DIR, 'oral/dict/eng_dict') #英文字典
num_dict = os.path.join(BASE_DIR, 'oral/dict/num_dict') #数字字典
sign_dict = os.path.join(BASE_DIR, 'oral/dict/sign_dict') #中文字典
save_path = os.path.join(BASE_DIR, 'oral/csv') #答案识别结果保存路径


def main(timeN):
    chi_img_path = os.path.join(BASE_DIR, 'oral/img_store/'+ timeN +'chi_img')
    eng_img_path = os.path.join(BASE_DIR, 'oral/img_store/'+ timeN +'eng_img')
    num_img_path = os.path.join(BASE_DIR, 'oral/img_store/'+ timeN +'num_img')
    sign_img_path = os.path.join(BASE_DIR, 'oral/img_store/'+ timeN +'sign_img')
